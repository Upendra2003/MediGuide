    ...
    return (
        <div>
            <div>
                    ...
                    <div className="container m-auto mt-7 z-0 relative">
                        ...
                        <div>
                            <div className="flex flex-col items-center mt-6">
                                <h1 className=' font-bold text-2xl mt-12'>Symptom Predictor</h1><br />
                                <div className='px-8 text-center text-slate-500'>Welcome to our Symptom Input Page - your first step towards personalized healthcare. Here, you have the opportunity to share your symptoms, allowing us to provide you with accurate and tailored medical advice.</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className=' }mx-4 sm:mx-0 pt-4 md:pt-4 h-5/6 my-10 rounded-lg '>
                    <div className='bg-white mt-2  h-full rounded-lg flex flex-col'>
                        <h2 className='text-2xl text-center pt-5 font-bold mb-4'>Symptoms List:</h2>
                        ...
                        <li key={index} className='flex items-center mx-2'>
                            <label className=' text-blue-600'>
                                <input
                                    type="checkbox"
                                    value={symptom}
                                    onChange={() => handleSymptomSelect(symptom)}mx-4 sm:mx-0 pt-4 md:pt-4 h-5/6 my-10 rounded-lg 
            ...
            {prediction.disease_name && modal && (
                <div className='modal'>
                    <div className="overlay">
                        <div className="modal-content sm:w-full" style={{minWidth: '310px',maxWidth:'600px'}}>
                            <div class="modal__face--front flex flex-col rounded-xl p-4 md:p-8 sm:p-4">
                                ...
                                {prediction.precautions && Object.keys(prediction.precautions).length > 0 ? (
                                    <div>
                                        ...
                                        <button type='submit' onClick={togglemodal} class="relative px-5 py-3 overflow-hidden font-medium text-gray-600 bg-gray-100 border border-gray-100 rounded-lg shadow-inner group">
                                            ...
                                            <span class="absolute bottom-0 left-0 w-full h-0 transition-all duration-300 delay-200 bg-gray-600 group-hover:h-full ease"></span>
                                            <span class="absolute inset-0 w-full h-full duration-300 delay-300 bg-gray-900 opacity-0 group-hover:opacity-100"></span>
                                            <span class="relative transition-colors duration-300 delay-200 group-hover:text-white ease"><Link to={'/hospitals'}>Nearby Hospitals</Link></span>
                                        </button>
                                    </div>
                                ) : (
